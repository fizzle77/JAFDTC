...
--
-- invokes the function JAFDTC_<airframe>_Fn_<fn> with the specified parameters (list of strings). the function should
-- return a string to be set as the responseVal in the telemetry.
--
