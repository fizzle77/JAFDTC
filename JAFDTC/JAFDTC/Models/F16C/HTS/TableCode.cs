// ********************************************************************************************************************
//
// TableCode.cs -- f-16c hts manual table code
//
...
namespace JAFDTC.Models.F16C.HTS
{
    ...
    public sealed class TableCode : BindableObject
    {
        ...
        private string _code;                       // integer, on [1, 9999]
        public string Code
        {
            get => _code;
            set
            {
                string error = (string.IsNullOrEmpty(value) || IsIntegerFieldValid(value, 1, 9999)) ? null : "Invalid format";
