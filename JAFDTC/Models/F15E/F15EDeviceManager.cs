...
namespace JAFDTC.Models.F15E
{
    ...
    internal class F15EDeviceManager : AirframeDeviceManagerBase, IAirframeDeviceManager
    {
        ...
        public F15EDeviceManager()
        {
            ...
            AirframeDevice ufc = new(56, "UFC_PILOT");
            ufc.AddAction(3001, "PB1", delay, 1);
            ufc.AddAction(3002, "PB2", delay, 1);
            ufc.AddAction(3003, "PB3", delay, 1);
            ufc.AddAction(3004, "PB4", delay, 1);
            ufc.AddAction(3005, "PB5", delay, 1);
            ufc.AddAction(3006, "PB6", delay, 1);
            ufc.AddAction(3007, "PB7", delay, 1);
            ufc.AddAction(3008, "PB8", delay, 1);
            ufc.AddAction(3009, "PB9", delay, 1);
            ufc.AddAction(3010, "PB10", delay, 1);
            ufc.AddAction(3019, "GCML", delay, 1);
            ufc.AddAction(3020, "1", delay, 1);
            ufc.AddAction(3021, "2", delay, 1);
            ufc.AddAction(3022, "3", delay, 1);
            ufc.AddAction(3023, "GCMR", delay, 1);
            ufc.AddAction(3025, "4", delay, 1);
            ufc.AddAction(3026, "5", delay, 1);
            ufc.AddAction(3027, "6", delay, 1);
            ufc.AddAction(3030, "7", delay, 1);
            ufc.AddAction(3031, "8", delay, 1);
            ufc.AddAction(3032, "9", delay, 1);
            ufc.AddAction(3036, "0", delay, 1);
            ufc.AddAction(3029, ".", delay, 1);
            ufc.AddAction(3033, "SHF", delay, 1);
            ufc.AddAction(3038, "MENU", delay, 1);
            ufc.AddAction(3035, "CLR", delay, 1);
            ufc.AddAction(3011, "PRESLCCW", delay, -1);
            ufc.AddAction(3012, "PRESRCCW", delay, -1);
            ufc.AddAction(3055, "PRESL", delay, 1);
            ufc.AddAction(3056, "PRESR", delay, 1);
            AddDevice(ufc);
